document.getElementById("generateButton").addEventListener("click", () => {
    ...
    // Generate password
    const password = generatePassword(includeLetters, includeNumbers, includeSpecialChars, minLength);
...
function generatePassword(includeLetters, includeNumbers, includeSpecialChars, minLength) {
